...
function func206(this: any) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (key_Z_on == 1 || key_A_on == 1) {
            ...
            if (var_910 == 0) {
                var_10 = 0;
                width(340, 340); // Ver0.1401にて修正。width(340, 340); → width(340, 340); 
            }
            if (var_910 == 1) {
                var_10 = 1;
                width(340, 340);
...
function func243(this: any) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (dangeon_number == 5 && current_floor == var_20) {
            var_86 = 0; // Ver0.1403にて修正 1 → 0。ランダムダンジョンマップ生成フラグOFF
        }
...
function func244(this: any) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // No = 5 なので、鉄獄(鉄の牢獄)
        if (dangeon_number == 5 && current_floor == var_20) { // 最終フロアケープカナベラル
            special_map_id = 120; // 自由人の狂想曲のダンジョンマップ(ケープカナベラルとしても使用)
        }
        if (special_floor == 1) { // 虹村屋敷

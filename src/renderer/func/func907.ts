...
async function func907(this: any) {
        Adap.dbgprt(907);
        await Func.func426();
        await Func.func427();
        await Func.func428();
        ...
        Gvar.var_3516[0] = Gvar.shageki_disc_id;
        ...
        Gvar.var_3516[6] = Gvar.var_567;
        Gvar.var_3516[7] = Gvar.var_350;
        ...
        Gvar.var_3516[19] = Gvar.var_233[Gvar.var_556].Var3;
        Gvar.var_3566 = 0;
        Gvar.var_3567 = "捨送";

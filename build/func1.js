        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(receive_bgm_id == belongings_item_list)) return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_X_on == 1 || key_A_on == 1 || key_S_on == 1 || key_Shift_on == 1 || key_C_on == 1)) return [3 /*break*/, 25];
                ...
                case 17:
                    _a.sent(); // ログイン画面表示(冒険に出る、ボス日記を消す、魔少年の問題、配布サイトへ、終了)
                    return [4 /*yield*/, func180()];
                case 18:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 3];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                ...
                case 2:
                    ...
                    return [2 /*return*/];
                case 3:
                    if (!(key_X_on == 1)) return [3 /*break*/, 21];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func178()];
                case 4:
                    _a.sent(); // 処理確認タイマー(3m秒)
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 7];
                ...
                case 3:
                    _a.sent(); // オープニング (5部最終決戦 ジョルノ達との戦いの場面)
                    return [2 /*return*/];
                ...
                case 6:
                    _a.sent(); // セーブデータを読み込む前のフラグ確認処理(ホテルのイベントフラグ、BGM再生曲、マップ背景画像)
                    return [2 /*return*/];
                case 7:
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 10];
                ...
                case 9:
                    ...
                    return [2 /*return*/];
                case 10:
                    if (!(key_X_on == 1)) return [3 /*break*/, 13];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func178()];
                case 11:
                    _a.sent(); // 処理確認タイマー(3m秒)
                ...
                case 23:
                    _a.sent(); // ボス日記選択画面(タイトル画面/ログイン画面/ボス日記選択画面)の表示
                ...
                case 27:
                    _a.sent(); // ログイン画面(タイトル画面/ログイン)動作処理 (ボス日記選択等のセーブデータロード処理)
                    return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent(); // 各キー入力確認
                    if (!(key_X_on == 1)) return [3 /*break*/, 7];
                    return [4 /*yield*/, func178()];
                case 5:
                    _a.sent(); // 処理確認タイマー(3m秒)
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 135:
                    ...
                    _a.label = 136;
                case 136:
                    if (!(cnt1_22 < 2)) return [3 /*break*/, 146];
                    var_83[4].Var5 = 7;
                ...
                case 146:
                    ...
                    _a.label = 147;
                case 147:
                    if (!(cnt1_23 < 8)) return [3 /*break*/, 150];
                    return [4 /*yield*/, func337()];
                case 148:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 149;
                ...
                case 170:
                    ...
                    _a.label = 171;
                case 171:
                    if (!(cnt1_24 < 30)) return [3 /*break*/, 174];
                    return [4 /*yield*/, func337()];
                case 172:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 173;
                ...
                case 174:
                    ...
                    _a.label = 175;
                case 175:
                    if (!(cnt1_25 < 51)) return [3 /*break*/, 178];
                    return [4 /*yield*/, func337()];
                case 176:
                    _a.sent(); // メッセージ関係呼び出し
                    var_311 = var_311 + 5;
                ...
                case 178:
                    ...
                    _a.label = 179;
                case 179:
                    if (!(cnt1_26 < 20)) return [3 /*break*/, 182];
                    return [4 /*yield*/, func337()];
                case 180:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 181;
                ...
                case 188:
                    ...
                    _a.label = 189;
                case 189:
                    if (!(cnt1_27 < 50)) return [3 /*break*/, 192];
                    return [4 /*yield*/, func337()];
                case 190:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 191;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 14:
                    ...
                    _a.label = 15;
                case 15:
                    if (!(cnt1_60 < 10)) return [3 /*break*/, 19];
                    var_758 = 1;
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                case 16:
                ...
                case 21:
                    ...
                    _a.label = 22;
                case 22:
                    if (!(cnt1_61 < 2)) return [3 /*break*/, 25];
                    return [4 /*yield*/, func337()];
                case 23:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 24;
                ...
                case 25:
                    ...
                    _a.label = 26;
                case 26:
                    if (!(cnt1_62 < 5)) return [3 /*break*/, 29];
                    return [4 /*yield*/, func337()];
                case 27:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 28;
                ...
                case 29:
                    ...
                    _a.label = 30;
                case 30:
                    if (!(cnt1_63 < 2)) return [3 /*break*/, 33];
                    return [4 /*yield*/, func337()];
                case 31:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 32;
                ...
                case 33:
                    ...
                    _a.label = 34;
                case 34:
                    if (!(cnt1_64 < 5)) return [3 /*break*/, 37];
                    return [4 /*yield*/, func337()];
                case 35:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 36;
                ...
                case 37:
                    ...
                    _a.label = 38;
                case 38:
                    if (!(cnt1_65 < 2)) return [3 /*break*/, 41];
                    return [4 /*yield*/, func337()];
                case 39:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 40;
                ...
                case 41:
                    ...
                    _a.label = 42;
                case 42:
                    if (!(cnt1_66 < 5)) return [3 /*break*/, 45];
                    return [4 /*yield*/, func337()];
                case 43:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 44;
                ...
                case 45:
                    ...
                    _a.label = 46;
                case 46:
                    if (!(cnt1_67 < 2)) return [3 /*break*/, 49];
                    return [4 /*yield*/, func337()];
                case 47:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 48;
                ...
                case 49:
                    ...
                    _a.label = 50;
                case 50:
                    if (!(cnt1_68 < 5)) return [3 /*break*/, 53];
                    return [4 /*yield*/, func337()];
                case 51:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 52;
                case 52:
                    ++cnt1_68;
                    return [3 /*break*/, 50];
                case 53: return [4 /*yield*/, func340()];
                case 54:
                    _a.sent(); // キー入力による選択処理
                    return [4 /*yield*/, func094()];
                case 55:
                ...
                case 71:
                    ...
                    _a.label = 72;
                case 72:
                    if (!(cnt1_69 < 20)) return [3 /*break*/, 75];
                    return [4 /*yield*/, func337()];
                case 73:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 74;
                case 74:
                    ++cnt1_69;
                    return [3 /*break*/, 72];
                case 75: return [4 /*yield*/, func336()];
                case 76:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 10:
                    ...
                    _a.label = 11;
                case 11:
                    if (!(cnt1_89 < 10)) return [3 /*break*/, 15];
                    var_758 = 1;
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                case 12:
                ...
                case 17:
                    ...
                    _a.label = 18;
                case 18:
                    if (!(cnt1_90 < 2)) return [3 /*break*/, 21];
                    return [4 /*yield*/, func337()];
                case 19:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 20;
                ...
                case 21:
                    ...
                    _a.label = 22;
                case 22:
                    if (!(cnt1_91 < 5)) return [3 /*break*/, 25];
                    return [4 /*yield*/, func337()];
                case 23:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 24;
                ...
                case 25:
                    ...
                    _a.label = 26;
                case 26:
                    if (!(cnt1_92 < 2)) return [3 /*break*/, 29];
                    return [4 /*yield*/, func337()];
                case 27:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 28;
                ...
                case 29:
                    ...
                    _a.label = 30;
                case 30:
                    if (!(cnt1_93 < 5)) return [3 /*break*/, 33];
                    return [4 /*yield*/, func337()];
                case 31:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 32;
                ...
                case 33:
                    ...
                    _a.label = 34;
                case 34:
                    if (!(cnt1_94 < 2)) return [3 /*break*/, 37];
                    return [4 /*yield*/, func337()];
                case 35:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 36;
                ...
                case 37:
                    ...
                    _a.label = 38;
                case 38:
                    if (!(cnt1_95 < 5)) return [3 /*break*/, 41];
                    return [4 /*yield*/, func337()];
                case 39:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 40;
                ...
                case 41:
                    ...
                    _a.label = 42;
                case 42:
                    if (!(cnt1_96 < 2)) return [3 /*break*/, 45];
                    return [4 /*yield*/, func337()];
                case 43:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 44;
                ...
                case 45:
                    ...
                    _a.label = 46;
                case 46:
                    if (!(cnt1_97 < 5)) return [3 /*break*/, 49];
                    return [4 /*yield*/, func337()];
                case 47:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 48;
                case 48:
                    ++cnt1_97;
                    return [3 /*break*/, 46];
                case 49: return [4 /*yield*/, func340()];
                case 50:
                    _a.sent(); // キー入力による選択処理
                    return [4 /*yield*/, func094()];
                case 51:
                ...
                case 52:
                    ...
                    _a.label = 53;
                case 53:
                    if (!(cnt1_98 < 20)) return [3 /*break*/, 56];
                    return [4 /*yield*/, func337()];
                case 54:
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 55;
                case 55:
                    ++cnt1_98;
                    return [3 /*break*/, 53];
                case 56: return [4 /*yield*/, func336()];
                case 57:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 34:
                    _a.sent(); // 初めてヴェネチアホテルへ訪れた際のディアボロの呟き
                    _a.label = 35;
                case 35:
                ...
                case 36:
                    _a.sent(); // ホテルの外初クリア後(エンヤホテル)、ヴェネチアホテルに戻った際のイベント
                    _a.label = 37;
                case 37:
                ...
                case 38:
                    _a.sent(); // レクイエムの大迷宮初クリア後、ヴェネチアホテルに戻った際のイベント
                    _a.label = 39;
                case 39:
                ...
                case 40:
                    _a.sent(); // 初めてダンジョンを訪れ、クリア出来ずにヴェネチアホテルに戻った際のディアボロの呟き
                    _a.label = 41;
                case 41:
                ...
                case 42:
                    _a.sent(); // ディアボロの試練開放イベント(岸辺露伴がヤギを追いかけるイベント)
                    _a.label = 43;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    ...
                    return [2 /*return*/];
                case 12:
                    if (!(key_X_on == 1)) return [3 /*break*/, 16];
                    return [4 /*yield*/, func178()];
                case 13:
                    _a.sent(); // 処理確認タイマー(3m秒)
                    return [4 /*yield*/, func167()];
                ...
                case 18:
                    ...
                    return [2 /*return*/];
                case 19:
                    if (!(key_X_on == 1)) return [3 /*break*/, 23];
                    var_790 = 0;
                    var_791 = 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 8:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 17];
                ...
                case 10:
                    _a.sent(); // 配列処理 (装備discの能力、Track等の並び替え)
                    return [2 /*return*/];
                case 11:
                ...
                case 16:
                    ...
                    return [2 /*return*/];
                case 17:
                    if (!(key_X_on == 1)) return [3 /*break*/, 20];
                    var_794 = 0;
                    return [4 /*yield*/, func178()];
                case 18:
                    _a.sent(); // 処理確認タイマー(3m秒)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    mes(var_808);
                    track_number = 1;
                    for (cnt1_114 = 0; cnt1_114 < var_810 + free_space_value; ++cnt1_114) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // 装備discの説明欄 (合成した能力などの表示)
                    if (!(var_10 >= 1)) return [3 /*break*/, 3];
                    return [4 /*yield*/, func338()];
                case 2:
                    _a.sent();
                ...
                case 8:
                    _a.sent(); // 各キー入力確認
                    if (!(key_X_on == 1)) return [3 /*break*/, 11];
                    var_800 = 0;
                    return [4 /*yield*/, func178()];
                case 9:
                    _a.sent(); // 処理確認タイマー(3m秒)
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent(); // スコア表示？ gettime等時間に関するものがある
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 23];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                ...
                case 19:
                    ...
                    return [2 /*return*/];
                case 20:
                    if (!(var_899 == 6 && dangeon_number != 99 && var_637 == 0)) return [3 /*break*/, 23];
                    return [4 /*yield*/, func051()];
                case 21:
                    _a.sent();
                ...
                case 22:
                    ...
                    return [2 /*return*/];
                case 23:
                    if (!(key_X_on == 1)) return [3 /*break*/, 26];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    var_509 = 0;
                    return [4 /*yield*/, func051()];
                case 24:
                ...
                case 25:
                    ...
                    return [2 /*return*/];
                case 26:
                    if (!(var_255 == 1)) return [3 /*break*/, 47];
                    if (!(var_899 == 0)) return [3 /*break*/, 29];
                    var_899 = 6;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 28:
                    ...
                    return [2 /*return*/];
                case 29:
                    if (!(var_899 == 1)) return [3 /*break*/, 32];
                    var_899 = 0;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 31:
                    ...
                    return [2 /*return*/];
                case 32:
                    if (!(var_899 == 2)) return [3 /*break*/, 35];
                    var_899 = 1;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 34:
                    ...
                    return [2 /*return*/];
                case 35:
                    if (!(var_899 == 3)) return [3 /*break*/, 38];
                    var_899 = 2;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 37:
                    ...
                    return [2 /*return*/];
                case 38:
                    if (!(var_899 == 4)) return [3 /*break*/, 41];
                    var_899 = 3;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 40:
                    ...
                    return [2 /*return*/];
                case 41:
                    if (!(var_899 == 5)) return [3 /*break*/, 44];
                    var_899 = 4;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 43:
                    ...
                    return [2 /*return*/];
                case 44:
                    if (!(var_899 == 6)) return [3 /*break*/, 47];
                    var_899 = 5;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 46:
                    ...
                    return [2 /*return*/];
                case 47:
                    if (!(var_259 == 1)) return [3 /*break*/, 68];
                    if (!(var_899 == 6)) return [3 /*break*/, 50];
                    var_899 = 0;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 49:
                    ...
                    return [2 /*return*/];
                case 50:
                    if (!(var_899 == 5)) return [3 /*break*/, 53];
                    var_899 = 6;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 52:
                    ...
                    return [2 /*return*/];
                case 53:
                    if (!(var_899 == 4)) return [3 /*break*/, 56];
                    var_899 = 5;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 55:
                    ...
                    return [2 /*return*/];
                case 56:
                    if (!(var_899 == 3)) return [3 /*break*/, 59];
                    var_899 = 4;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 58:
                    ...
                    return [2 /*return*/];
                case 59:
                    if (!(var_899 == 2)) return [3 /*break*/, 62];
                    var_899 = 3;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 61:
                    ...
                    return [2 /*return*/];
                case 62:
                    if (!(var_899 == 1)) return [3 /*break*/, 65];
                    var_899 = 2;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 64:
                    ...
                    return [2 /*return*/];
                case 65:
                    if (!(var_899 == 0)) return [3 /*break*/, 68];
                    var_899 = 1;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 67:
                    _a.sent();
                    return [2 /*return*/];
                case 68: return [4 /*yield*/, func193()];
                case 69:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 5];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 3:
                    _a.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/];
                case 5:
                    if (!(key_X_on == 1)) return [3 /*break*/, 8];
                    return [4 /*yield*/, func051()];
                case 6:
                    _a.sent();
                    var_900 = 0;
                ...
                case 7:
                    ...
                    return [2 /*return*/];
                case 8:
                    if (!(var_255 == 1)) return [3 /*break*/, 18];
                    if (!(var_906 == 0)) return [3 /*break*/, 10];
                    var_906 = 0;
                    var_686 = 30;
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                case 9:
                    ...
                    _a.label = 10;
                case 10:
                    if (!(var_906 == 1)) return [3 /*break*/, 12];
                    var_906 = 0;
                    var_686 = 30;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 11:
                    ...
                    _a.label = 12;
                case 12:
                    if (!(var_906 == 2)) return [3 /*break*/, 14];
                    var_906 = 1;
                    var_686 = 40;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 13:
                    ...
                    _a.label = 14;
                case 14:
                    if (!(var_906 == 3)) return [3 /*break*/, 16];
                    var_906 = 2;
                    var_686 = 50;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 15:
                    ...
                    _a.label = 16;
                case 16:
                    if (!(var_906 == 4)) return [3 /*break*/, 18];
                    var_906 = 3;
                    var_686 = 60;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 18:
                    ...
                    if (!(var_906 == 4)) return [3 /*break*/, 20];
                    var_906 = 4;
                    var_686 = 70;
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                case 19:
                    ...
                    _a.label = 20;
                case 20:
                    if (!(var_906 == 3)) return [3 /*break*/, 22];
                    var_906 = 4;
                    var_686 = 70;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 21:
                    ...
                    _a.label = 22;
                case 22:
                    if (!(var_906 == 2)) return [3 /*break*/, 24];
                    var_906 = 3;
                    var_686 = 60;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 23:
                    ...
                    _a.label = 24;
                case 24:
                    if (!(var_906 == 1)) return [3 /*break*/, 26];
                    var_906 = 2;
                    var_686 = 50;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 25:
                    ...
                    _a.label = 26;
                case 26:
                    if (!(var_906 == 0)) return [3 /*break*/, 28];
                    var_906 = 1;
                    var_686 = 40;
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    // yield func337(); // メッセージ関係呼び出し
                ...
                case 27:
                    ...
                    _a.sent(); // メッセージ関係呼び出し
                    _a.label = 28;
                case 28: return [4 /*yield*/, func195()];
                case 29:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent(); // 各キー入力確認
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 15];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                ...
                case 14:
                    ...
                    return [2 /*return*/];
                case 15:
                    if (!(key_X_on == 1)) return [3 /*break*/, 18];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 16:
                    _a.sent();
                ...
                case 17:
                    ...
                    return [2 /*return*/];
                case 18:
                    if (!(var_255 == 1)) return [3 /*break*/, 24];
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    if (!(var_908 == 0)) return [3 /*break*/, 21];
                    var_908 = 2;
                ...
                case 20:
                    ...
                    return [2 /*return*/];
                case 21:
                    if (!(var_908 != 0)) return [3 /*break*/, 24];
                    var_908 = var_908 - 1;
                    // ここ間違えてる？？なぜ func337() が2回も呼ばれる？
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 23:
                    ...
                    return [2 /*return*/];
                case 24:
                    if (!(var_259 == 1)) return [3 /*break*/, 30];
                    DSPLAY(audio_id = 100); // アイテム選択時の効果音
                    if (!(var_908 == 2)) return [3 /*break*/, 27];
                    var_908 = 0;
                    // ここ間違えてる？？なぜ func337() が2回も呼ばれる？
                    // yield func337(); // メッセージ関係呼び出し
                    return [4 /*yield*/, func337()];
                ...
                case 29:
                    _a.sent();
                    return [2 /*return*/];
                case 30: return [4 /*yield*/, func199()];
                case 31:
                    _a.sent();
                    return [2 /*return*/];
            }

    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent(); // 読み込んだ"img_3.gif"ファイルからロード時の"石仮面"、"進行バー"の座標指定処理
                    var_18 = var_18 + 10;
                    _a.label = 5;
                case 5:
                    ++cnt1_2;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dbgprt(11);
                    var_268 = 0;
                    if (!(equip_disc[316] == 0)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    return [2 /*return*/];
                case 2:
                    if (!(equip_disc[316] == 1)) return [3 /*break*/, 4];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 42:
                    ...
                    return [2 /*return*/];
                case 43:
                    if (!(equip_disc[311] == 1 && var_144 == 0 && var_218 == 0)) return [3 /*break*/, 46];
                ...
                case 64:
                    ...
                    _a.label = 65;
                case 65:
                    if (!(equip_disc[315] == 1 && var_144 == 0 && var_262 == 0 && var_218 == 0)) return [3 /*break*/, 70];
                ...
                case 153:
                    ...
                    var_158 = var_158 + 1;
                    if (!(equip_disc[396] == 1)) return [3 /*break*/, 155];
                    var_158 = 0;
                ...
                case 175:
                    ...
                    _a.label = 176;
                case 176:
                    if (!(equip_disc[302] == 1 && var_262 == 0 && var_144 == 0 && var_218 == 0 && var_128 == 0 && var_219 == 0 && var_178 == 0 && var_139 == 0)) return [3 /*break*/, 182];
                    var_388 = rnd(200);
                ...
                case 181:
                    ...
                    return [2 /*return*/];
                case 182:
                    if (!(equip_disc[310] == 1 && var_262 == 0 && var_144 == 0 && var_218 == 0 && var_128 == 0 && var_219 == 0 && var_178 == 0 && var_139 == 0)) return [3 /*break*/, 191];
                    var_388 = rnd(200);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 22:
                    _a.sent();
                    if (!(equip_disc[396] == 1)) return [3 /*break*/, 27];
                    return [4 /*yield*/, func340()];
                case 23:
                    _a.sent(); // キー入力による選択処理
                    return [4 /*yield*/, func094()];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 41:
                    ...
                    return [2 /*return*/];
                case 42:
                    if (!(key_Z_on == 1 || key_A_on == 1)) return [3 /*break*/, 70];
                    if (!(var_500 == 0 && var_501 == 0)) return [3 /*break*/, 48];
                    var_501 = 1;
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 43:
                ...
                case 47:
                    ...
                    return [2 /*return*/];
                case 48:
                    if (!(var_500 == 0 && var_501 == 1)) return [3 /*break*/, 54];
                    var_501 = 0;
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 49:
                ...
                case 53:
                    ...
                    return [2 /*return*/];
                case 54:
                    if (!(var_500 == 1)) return [3 /*break*/, 57];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 55:
                    _a.sent();
                ...
                case 56:
                    ...
                    return [2 /*return*/];
                case 57:
                    if (!(var_500 == 2)) return [3 /*break*/, 60];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    var_505 = 0;
                    var_506 = 19;
                    var_507 = 45;
                ...
                case 59:
                    ...
                    return [2 /*return*/];
                case 60:
                    if (!(var_500 == 3)) return [3 /*break*/, 63];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 61:
                    _a.sent();
                ...
                case 62:
                    ...
                    return [2 /*return*/];
                case 63:
                    if (!(var_500 == 4 && var_375 == 0)) return [3 /*break*/, 66];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 64:
                    _a.sent();
                ...
                case 65:
                    ...
                    return [2 /*return*/];
                case 66:
                    if (!(var_500 == 4 && var_375 == 1)) return [3 /*break*/, 70];
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    var_499 = 0; // Mフラグ:設定画面 func056
                    return [4 /*yield*/, func051()];
                case 67:
                ...
                case 69:
                    ...
                    return [2 /*return*/];
                case 70:
                    if (!(key_X_on == 1)) return [3 /*break*/, 73];
                    var_499 = 0; // Mフラグ:設定画面 func056
                    DSPLAY(audio_id = 212); // メニュー画面を開く or 各設定項目を開く時の効果音
                    return [4 /*yield*/, func051()];
                case 71:
                ...
                case 72:
                    _a.sent(); // ゲーム開始後の基本画面 (メニュー画面を閉じたりすると、かならずfunc009を呼び出す)
                    return [2 /*return*/];
                case 73: return [4 /*yield*/, func055()];
                case 74:
                    _a.sent();
                    return [2 /*return*/];
            }

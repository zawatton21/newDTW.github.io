...
推奨します
*/
function bsave(file_name: any, data: any, data_size: any = null, offset: any = null) {
...
function buffer(id: any, disp_width: any = null, disp_height: any = null, mode: any = null) {
    ...
    contexts[id] = (render_canvas as any).getContext('2d');
...
function delete_(file_name: any) { // Ver0.1310で追加。冒険日記個別削除機能。
...
function dialog(data0: string, data1: number, data2: string = null) { 
    if (data1 == 32) {
        document.getElementById('colorpicker').click(); // Ver 0.1310で追加。カラーパレット表示
    }
}
...
function noteinfo(info_type) {
    if (info_type == 0) {
        ...
        const sum = 0;
        for (let i in note_data[selected_note]) {
...
function DMLOADMEMORY(music_id: any, data0: any, data1: any) {
    ...
    (document.getElementById(bgm_source1) as any).load();
}
...
function ck_joystick(data0:any, data1:any = null) {
    return 0;
}
function netclose(data0:any, data1:any = null, data2:any = null, data3:any = null) { }
function netfail(data0:any, data1:any = null, data2:any = null, data3:any = null) { }
function netinit(data0:any, data1:any, data2:any, data3:any) { }
function tcpopen(data0:any, data1:any, data2:any) { }
function tcpiscon(data0:any) { }
function tcpcount(data0:any, data1:any) { }
function tcpgetl(data0:any, data1:any, data2:any) { }
function tcpput(data0: any, data1: any) { }
function GetWindowLongA(data1:any,ata2:any) { }
function SetWindowLongA(data1:any, data2:any, data3:any) { }
function SetWindowPos(hwnd:any, data1:any, data2:any, data3:any, data4:any, data5:any, data6:any) { }
